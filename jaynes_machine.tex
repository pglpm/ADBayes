...
%% Last-Updated: 2023-01-15T14:03:54+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{\large Personalized prognosis \amp\ treatment using Turing-Jaynes machines:\\{Proofs}%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Personalized prognosis \amp\ treatment using a \tjm}
