...
## Last-Updated: 2021-12-09T18:19:08+0100
################
...
frequenciesfile <- paste0(dirname,'/','_frequencies-RnewposteriorRdIndO_3-V13-D539-K64-I1024.rds')
...
##
mean(rowMeans(predictionsc,na.rm=T)*log2(1/rowMeans(predictions,na.rm=T)))
## > [1] 0.428 bit
sd(rowMeans(predictionsc,na.rm=T)*log2(1/rowMeans(predictions,na.rm=T)),na.rm=T)
## > [1] 0.132 bit
...
signif(cbind(sort(dropmis,decreasing=F)),2)
