...
## Last-Updated: 2021-12-11T11:58:39+0100
################
...
seed <- 149
baseversion <- 'newpriorRd_'
nclusters <- as.integer(64) #as.integer(2^6)
niter <- as.integer(1024) #as.integer(2^11)
niter0 <- as.integer(1024) #as.integer(2^10)
thin <- as.integer(8)
nstages <- 1L
