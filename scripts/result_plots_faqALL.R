...
## Last-Updated: 2021-12-14T11:39:42+0100
################
...
dirname <- 'FAQposteriorALL_-V13-D708-K75-I1024'
outfile <- paste0(dirname,'/','results.txt')
frequenciesfile <- paste0(dirname,'/','_frequencies-RFAQposteriorALL_1-V13-D708-K75-I1024.rds')
