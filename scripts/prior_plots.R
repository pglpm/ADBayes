...
## Last-Updated: 2021-12-11T14:36:12+0100
################
...
dirname <- 'newpriorRd_-V13-D539-K64-I1024'
outfile <- paste0(dirname,'/','results.txt')
frequenciesfile <- paste0(dirname,'/','_frequencies-RnewpriorRd_1-V13-D539-K64-I1024.rds')
