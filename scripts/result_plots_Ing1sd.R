...
## Last-Updated: 2021-12-21T09:48:15+0100
################
...
dirname <- 'Ing_posterior1_-V13-D539-K75-I1024'
frequenciesfile <- '_frequencies-RIng_posterior1_3-V13-D539-K75-I1024.rds'
datafile <- 'traindataIng_transformed_shuffled.csv'
...
appr <- cbind(1-dropmis[,1]/mutualinfo[1],
          (dropmis[,2]/dropmis[,1] + mutualinfo[2]/mutualinfo[1]) * (1-dropmis[,1]/mutualinfo[1])
          )*100
