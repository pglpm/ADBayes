...
%% Last-Updated: 2021-12-18T10:44:49+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
about a fraction $(1-H)\,N$ of the values of future occurrences. A more
precise formula gives
\begin{equation}
  \label{eq:entropy_est}
  \begin{gathered}
    \text{\# correct predictions } = C\,N \pm 2\sqrt{(1-C)\,C\,N}
    \\[1\jot]
    \text{\small with}\quad C = \Bigl[1+\sqrt{1-H^{4/3}}\Bigr]\frac{N}{2} \ .
\end{gathered}
\end{equation}
The entropy is also related to the size of the typical set of different
sequences of values we can see in $N$ occurrences: the size is $2^{H}$.
