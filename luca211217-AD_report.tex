...
%% Last-Updated: 2021-12-17T13:07:42+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
chapters of \textcite{mackay1995_r2005} and also his
lectures\footnote{\href{https://www.youtube.com/watch?v=BCiZc0n6COY\&list=PLruBu5BI5n4aFpG32iMbdWoRVAA-Vcso6}{\texttt{\doiurl{https://www.youtube.com/watch?v=BCiZc0n6COY&list=PLruBu5BI5n4aFpG32iMbdWoRVAA-Vcso6}}}},
besides \textcite{shannon1948}.
...
uncertainty). A value of $H$ (in bits) means that we are on average certain
about a fraction $(1-H)\,N$ of the values of future occurrences, and completely
uncertain about the rest. This also means that we will correctly predict an
average of $(2-H)\,N/2$ future values, with a 95\% variability of
$\sqrt{H\,N}$. The entropy is also related to the size of the typical
...
predictions are almost perfect (entropy of 1\;\bit) when the value of $X$
is in some range $R_{\text{good}}$; whereas their are very bad (entropy of
0\;\bit) when the value is in the complementary range $R_{\text{bad}}$. Is
