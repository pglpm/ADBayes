...
####
rshapeins <- c(1,0.5,2)
rshapeouts <- c(1,0.5,2)
rvarscales <- c(1,0.5,2)
oshapeins <- c(1,0.5,2)
oshapeouts <- c(1,0.5,2)
ovarscales <- c(1,0.5,2)
dshapeins <- c(1,0.5,2)
dshapeouts <- c(1,0.5,2)
dvarscales <- c(1,0.5,2)
ishapeins <- c(1,0.5,2)
ishapeouts <- c(1,0.5,2)
ivarscales <- c(1/4,1/8,1/2)
...
initsFunction <- function(){
    c(
        ...
        if(len$R > 0){list( # real variate
                     ...
                     Rvarscaleindex=rep(1,len$R),
                     Rshapeinindex=rep(1,len$R),
                     Rshapeoutindex=rep(1,len$R)
                 )},
        if(len$O > 0){list( # doubly-bounded variate
                     ...
                     Ovarscaleindex=rep(1,len$O),
                     Oshapeinindex=rep(1,len$O),
                     Oshapeoutindex=rep(1,len$O)
                 )},
        if(len$D > 0){list( # doubly-bounded variate
                     ...
                     Dvarscaleindex=rep(1,len$D),
                     Dshapeinindex=rep(1,len$D),
                     Dshapeoutindex=rep(1,len$D)
                 )},
        if(len$I > 0){list( # integer ordinal variate
                     ...
                     Ivarscaleindex=rep(1,len$I),
                     Ishapeinindex=rep(1,len$I),
                     Ishapeoutindex=rep(1,len$I)
                     )},
